...
class Actor : public DeviceConfig {
	public:
		...
		struct {
			...
			/// @brief Contains a map of actions this device can perform and their ID numbers. Action names must contain only alphanumeric and underscores, and contain at least one letter
